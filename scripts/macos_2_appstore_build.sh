...
sed -i '' 's/"CODE_SIGN_IDENTITY\[sdk=macosx\*]" = "Developer ID Application";/"CODE_SIGN_IDENTITY[sdk=macosx*]" = "Apple Distribution";/g' macos/Runner.xcodeproj/project.pbxproj
